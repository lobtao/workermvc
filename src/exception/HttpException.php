...
class HttpException extends \Exception
{
    ...
    public function loadTemplate($template, $vars = []){
        $template = file_get_contents(WORKERMVC_PATH."src".DS."tpl".DS.$template.".html");
    ...
    public function formEnvTable(){
        ...
        $tableHtml .= "<tr><td class=\"debug-tracing-table-key\">".think_core_lang("tracing page env workermvc version")."</td><td class=\"debug-tracing-table-value\">".WORKERMVC_VERSION."</td></tr>";
